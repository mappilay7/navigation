<?php
  ...
  if (isset($_POST['upload'])) {
    $target = "space/".basename($_FILES['image']['name']);
    $conn = mysqli_connect("localhost", "root", "", "intiproject");

    $image = $_FILES['image']['name'];
    $text = $_POST['text'];

    $sql = "INSERT INTO space (image, text) VALUES('$image','$text')";
...
          </ul>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="spacefunc.php">SpaceUpD</a></li>
...
?>
  <form method="post" action="spacefunc.php" enctype="multipart/form-data">
