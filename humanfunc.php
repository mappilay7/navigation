<?php
  ...
  if (isset($_POST['upload'])) {
    $target = "human/".basename($_FILES['image']['name']);
    $conn = mysqli_connect("localhost", "root", "", "intiproject");

    $image = $_FILES['image']['name'];
    $text = $_POST['text'];

    $sql = "INSERT INTO human (image, text) VALUES('$image','$text')";
...
          </ul>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="humanfunc.php">HumanUpD</a></li>
...
?>
  <form method="post" action="humanfunc.php" enctype="multipart/form-data">
