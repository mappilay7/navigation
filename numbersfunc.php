<?php
  ...
  if (isset($_POST['upload'])) {
    $target = "numbers/".basename($_FILES['image']['name']);
    $conn = mysqli_connect("localhost", "root", "", "intiproject");

    $image = $_FILES['image']['name'];
    $text = $_POST['text'];

    $sql = "INSERT INTO numbers (image, text) VALUES('$image','$text')";
...
          </ul>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li ><a href="adminsub.php">AnimalsUpD</a></li>
        <li><a href="spacefunc.php">SpaceUpD</a></li>
        <li class="active"><a href="numbersfunc.php">NumbersUpD</a></li>
...
?>
  <form method="post" action="numbersfunc.php" enctype="multipart/form-data">
